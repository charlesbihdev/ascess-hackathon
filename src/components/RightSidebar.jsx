    ...
    >
      <div className="text-black font-bold m-4">
        ...
        <div className="flex justify-around">
          <div className="bg-[url('/images/avatar/laptop2.jpeg')] bg-cover bg-center flex flex-col justify-end  h-36 bg-slate-400 w-2/5 rounded-2xl overflow-hidden ">
          ...
          <div className="bg-[url('/images/avatar/idcard.jpeg')] bg-cover bg-center flex flex-col justify-end  h-36 bg-slate-400 w-2/5 rounded-2xl overflow-hidden">
            <div className="flex bg-white mx-auto gap-1 p-1 m-1 rounded-xl font-normal text-sm ">
        ...
        <div className="flex flex-col">
          ...
          <EventCard
            ...
            month="Nov"
            time="3:00 PM"
            eventTitle="Misplaced student id "
            address="LH3"
          />
        </div>
      </div>
